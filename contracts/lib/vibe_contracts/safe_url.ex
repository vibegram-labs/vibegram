defmodule VibeContracts.SafeURL do
  @moduledoc """
  SSRF guard: resolves the host and rejects loopback/private/link-local/CGNAT/
  metadata/ULA/IPv4-mapped-v6 addresses. Faithful copy of the core's `net/safe_url.ex`.
  """
