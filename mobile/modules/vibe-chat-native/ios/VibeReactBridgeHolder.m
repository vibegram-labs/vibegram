...
{
  NSLog(@"[VibeNativeCall][BridgeHolder] ping hasBridge=%@", sVibeBridgeObject != nil ? @"true" : @"false");
  return @(YES);
}
...
- (void)setBridge:(RCTBridge *)bridge
{
  ...
  NSLog(@"[VibeNativeCall][BridgeHolder] setBridge class=%@", NSStringFromClass([bridge class]));
}
